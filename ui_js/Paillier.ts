...
const publicKey: [bigint, bigint] = [
  ...
  BigInt(
    ''
  ),
];
const privateKey: [bigint, bigint] = [
  BigInt(
    '4646385036140001316436192383464767093852021203187463649710879748742433749699127697383300203735056451044517707604817329375971485031963258310218181207526330'
  ),
  BigInt(
